   ...
   // Function to prompt the user for input
    function getUserInputAndReplace() {
        ...
        if (userInput1 !== null && userInput2 !== null && userInput3 !== null && userInput4 !== null && userInput5 !== null && userInput6 !== null && userInput7 !== null && userInput9 !== null && userInput10 !== null && userInput11 !== null && userInput12 !== null && userInput13 !== null && userInput15 !== null && userInput16 !== null && userInput20 !== null) {
            ...
            pasteUserInputInTextarea('templateVariablesTable', 'templateVariables[{{10_NARG_tickets_Link}}]', userInput10);
            pasteUserInputInTextarea('templateVariablesTable', 'templateVariables[{{11_number_of_affected_devices}}]', userInput11);
            pasteUserInputInTextarea('templateVariablesTable', 'templateVariables[{{12_Quantity_Manufacturer_Model_rack_position}}]', userInput12);
            pasteUserInputInTextarea('templateVariablesTable', 'templateVariables[{{13_is_two_person_verification_required_for_this_activity_if_yes_explain}}]', userInput13);
            pasteUserInputInTextarea('templateVariablesTable', 'templateVariables[{{14_alias_of_Performer}}]', userInput14);
            pasteUserInputInTextarea('templateVariablesTable', 'templateVariables[{{15_alias_of_Verifier}}]', userInput15);
            pasteUserInputInTextarea('templateVariablesTable', 'templateVariables[{{16_list_all_hostnames_locations_production_status_and_if_in_scope_of_this_activity}}]', userInput16);
            ...
            pasteUserInputInTextarea('templateVariablesTable', 'templateVariables[{{21_have_we_segmented_this_change_into_small_enough_stages_to_minimize_the_blast_radius_accelerate_impact_detection_and_ease_rollback}}]', userInput21);
            pasteUserInputInTextarea('templateVariablesTable', 'templateVariables[{{22_what_is_the_justification_for_this_tier_level}}]', userInput22);
            pasteUserInputInTextarea('templateVariablesTable', 'templateVariables[{{23_list_every_step_that_you_will_take_during_your_activity}}]', userInput23);
